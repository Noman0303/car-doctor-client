...
const About = () => {
    return (
        <div className='my-32 p-2' id='about'>
            <div className=" min-h-[560px] rounded-xl ">

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5  ">

                    <div className='relative '>
                        <img src={person} className="lg:max-w-[460px] rounded-lg  " />
                        <img src={parts} className="lg:max-w-[325px] rounded-lg md:border-8 border-white  md:absolute md:top-56 lg:left-48 " />
                    </div>
